...
First we describe the techniques we used and evaluate if they are suitable for our particular design.
...
For separated implementing stage, frontend team members pull from “frontdev”, implementing their own part of work and executing unit tests, then push it back to frontdev, and backend team did similar thing with “xzn” branch.</br>
* **Functional testing timeline** - during Easter vacation until 23rd April</br>
After integrating the frontend and backend, all team members pull from “dev”, execute functional tests and push back. At this stage, some changes are made based on testing.</br>
* **User acceptance testing timeline** - 23rd April onwards</br>
At this stage, only a little changes are made based on testing. After first round of user testing (23rd April), “dev” branch is merged into “main” for the first time, but still, some bug fixing remain in “dev” branch.</br>
...
-- If a user's accuracy is between 60% and 80%, the image of normal shit icon will be displayed along with the text "Great job, try to learn more about how to write elegant code!".</br>
...
```
1. Can you manage to finish the whole quiz without any help from developers?
   a.yes
   b.met some problems
2. How do you feel about the quiz process?
   a.easy to explore
   b.not good, sometimes I get lost
3. How do you feel about the style of the website?
   a.good
   b.ugly
4. Do you think this website help raise your awareness of the importance of code quality?
   a.yes
   b.no
```
